...
class TestProjectSettings(common.TestCase):
    ...
    def testInitialization(self):
        ...
        # The video settings should match 1sec_simpsons_trailer.mp4
        self.assertEqual(1280, project.videowidth)
        self.assertEqual(544, project.videoheight)
        self.assertEqual(Gst.Fraction(24000, 1001), project.videorate)
